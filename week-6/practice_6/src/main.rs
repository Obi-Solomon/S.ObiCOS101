fn main(){
    ...
    println!("\nThe {} is informed by the aspiration
     to train electrican/electronic engineering professionals
     in the areas of design, building and mainrenance of 
    ...
    let w3 = w1 + &w2;
    println!();
    println!("{} is aimed at developing competent, creatige,
